...
class Blockchain(object):
    def __init__(self):
        self.chain = []
        self.nodes = set()  # hold the list of nodes
    ...
    def register_node(self, address):
        ...
        urlparse(): parse URL into six components (decompose),
        returning a 6-tuple
    ...
    def resolve_conflicts(self):
        ...
        # Replace our chain if discovered a new, valid chain lobger than ours
        if new_chain:
...
def mine():
    ...
    # Forge the new Block by adding it is to the chain
